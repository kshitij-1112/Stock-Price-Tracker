...
(async function testMyStocks() {
  ...
  try {
    ...
    await driver.findElement(By.name('mystocks')).click();
    // Navigate to the MyStocks page (adjust this step according to your app's navigation)
    await driver.get('http://localhost:3000/mystocks');
    ...
    await driver.findElement(By.name('analyseButton')).click();

    // Wait for 6 seconds as mentioned
    await driver.sleep(6000);

    // Click the "Collapse" button if available
    await driver.findElement(By.name('collapseButton')).click();
